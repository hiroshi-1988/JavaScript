'use strict';
    ...
    function updateTimetText(){
        ...
        //ms10(10ミリ秒) = 135200ミリ秒を % 1000ミリ秒で割った数(135秒)の余りが200ミリ秒。それを10で割って単位を10ミリ秒にする
        ms10 = Math.floor((elapsedTime % 1000) / 10);

        //文字列の末尾1桁を表示したいのでsliceで負の値(-1)引数で渡してやる
        ms10 = ('0' + ms10).slice(-1);

        //HTMLのid timer部分に表示させる
        timer.textContent = ms10;
